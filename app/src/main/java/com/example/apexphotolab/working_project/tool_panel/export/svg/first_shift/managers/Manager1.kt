package com.example.apexphotolab.working_project.tool_panel.export.svg.first_shift.managers

import com.example.apexphotolab.working_project.tool_panel.export.svg.first_shift.ColorSorter
import com.example.apexphotolab.working_project.tool_panel.export.svg.first_shift.FirstShiftWorker
import kotlinx.coroutines.ensureActive
import java.nio.ByteBuffer
import kotlin.coroutines.coroutineContext

/**
 * Manager #1 for the First Shift.
 * Implements the VRAM-aware worker contract.
 */
object Manager1 :
    FirstShiftWorker {
    ...
    override suspend fun processSlice(
        ...
        for (i in 0 until sliceCount) {
            // CORRECTED: Add the periodic cancellation check back into the main loop.
