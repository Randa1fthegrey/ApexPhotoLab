...
/**
 * A dedicated, private Color Palette for the Third Shift.
 * This MUST be an exact structural mirror of the main ColorPalette to ensure
 * indices match across shifts.
 */
