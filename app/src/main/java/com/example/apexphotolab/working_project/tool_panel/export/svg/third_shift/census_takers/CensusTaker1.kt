...
import com.example.apexphotolab.working_project.tool_panel.export.svg.third_shift.CensusNoiseFloor
...
/**
 * Census Taker #1 for the Third Shift.
...
object CensusTaker1 : ThirdShiftCensusTaker {
    ...
    override suspend fun analyzePath(
        ...
        // 7. Calculate Complexity with Noise Floor.
        val blendRatio = CensusNoiseFloor.apply(totalPixels, dominantCount)
