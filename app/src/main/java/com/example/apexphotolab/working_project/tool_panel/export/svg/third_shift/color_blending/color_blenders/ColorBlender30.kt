...
/**
 * Color Blender #30. The final member of the sampling army.
 */
object ColorBlender30 : ColorBlender {
    ...
    override fun blend(
        ...
        for (i in 0 until sampleCount) {
            ...
            val sampleY = (orthogonalSampleY(bounds, offsetY, isHorizontal)).coerceIn(0, sourceImage.height - 1)
    ...
    private fun orthogonalSampleY(bounds: Rect, offsetY: Int, isHorizontal: Boolean): Int {
        return if (!isHorizontal) bounds.top + offsetY else bounds.top + (bounds.height() / 2)
    }
