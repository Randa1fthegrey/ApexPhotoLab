...
/**
 * Job: The VRAM Construction Crew.
 * Single Responsibility: Marking specific paths as "Golden Rails" in the VRAM bitmask.
 * This ensures tracers have a solid, non-broken path to follow.
 */
object VRAM_Paver {

    /**
     * Paves a series of points into the VRAM bitmask.
     * Uses linear interpolation between points to ensure the path is continuous.
     */
    ...
    /**
     * Bresenham-style line algorithm to flip bits in VRAM between two points.
     */
