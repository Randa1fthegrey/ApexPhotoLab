...
/**
 * Consolidation specialist for the ALPHA/TRANSPARENCY color group.
 */
object AlphaConsolidator {

    private const val REACH_RADIUS = 15 // Longer reach for alpha to ensure large transparent regions stay unified
