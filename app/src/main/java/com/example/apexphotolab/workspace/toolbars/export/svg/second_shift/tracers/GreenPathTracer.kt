...
/**
 * The "Lonely Walker" Path Tracer specifically for GREEN shapes.
...
object GreenPathTracer {
    ...
    fun trace(edgePixels: HashSet<Point>, vram: ByteBuffer, width: Int): List<List<Point>> {
        TracerDiagnosticLogger.logWorkReceived("Green", edgePixels.size, 0)
        ...
        TracerDiagnosticLogger.logWorkSummary("Green", allPaths.size)
        return allPaths
    }
