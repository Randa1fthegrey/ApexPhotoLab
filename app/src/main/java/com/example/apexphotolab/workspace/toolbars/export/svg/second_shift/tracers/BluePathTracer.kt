...
/**
 * The "Lonely Walker" Path Tracer specifically for BLUE shapes.
...
object BluePathTracer {
    ...
    fun trace(edgePixels: HashSet<Point>, vram: ByteBuffer, width: Int): List<List<Point>> {
        TracerDiagnosticLogger.logWorkReceived("Blue", edgePixels.size, 0)
        ...
        TracerDiagnosticLogger.logWorkSummary("Blue", allPaths.size)
        return allPaths
    }
