...
/**
 * A manual TIFF (Tagged Image File Format) writer.
 * Implements a Baseline Little-Endian TIFF (8-bit RGBA).
 * Follows the TIFF 6.0 Specification.
 */
object TiffSaver {
    ...
    suspend fun saveFlattenedTiff(
        ...
        val imageDataOffset = 8 + ifdSize + (3 * 2) // Extra space for BitsPerSample array (4 entries * 2 bytes)
