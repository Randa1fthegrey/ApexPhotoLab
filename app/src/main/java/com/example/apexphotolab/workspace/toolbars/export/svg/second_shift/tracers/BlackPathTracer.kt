...
/**
 * The "Lonely Walker" Path Tracer specifically for BLACK shapes.
...
object BlackPathTracer {
    ...
    fun trace(edgePixels: HashSet<Point>, vram: ByteBuffer, width: Int): List<List<Point>> {
        TracerDiagnosticLogger.logWorkReceived("Black", edgePixels.size, 0)
        ...
        TracerDiagnosticLogger.logWorkSummary("Black", allPaths.size)
        return allPaths
    }
