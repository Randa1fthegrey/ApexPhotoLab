...
/**
 * The "Lonely Walker" Path Tracer specifically for CYAN shapes.
...
object CyanPathTracer {
    ...
    fun trace(edgePixels: HashSet<Point>, vram: ByteBuffer, width: Int): List<List<Point>> {
        TracerDiagnosticLogger.logWorkReceived("Cyan", edgePixels.size, 0)
        ...
        TracerDiagnosticLogger.logWorkSummary("Cyan", allPaths.size)
        return allPaths
    }
