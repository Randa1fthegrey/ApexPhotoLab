...
/**
 * The "Lonely Walker" Path Tracer specifically for WHITE/GREYSCALE shapes.
...
object WhitePathTracer {
    ...
    fun trace(edgePixels: HashSet<Point>, vram: ByteBuffer, width: Int): List<List<Point>> {
        TracerDiagnosticLogger.logWorkReceived("White", edgePixels.size, 0)
        ...
        TracerDiagnosticLogger.logWorkSummary("White", allPaths.size)
        return allPaths
    }
