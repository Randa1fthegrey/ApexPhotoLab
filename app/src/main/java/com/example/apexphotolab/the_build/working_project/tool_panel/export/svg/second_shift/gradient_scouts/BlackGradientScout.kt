...
/**
 * Job: Black Gradient Scout.
 * Responsibility: Pre-scanning the image for gradient transitions within the Black color group.
 */
object BlackGradientScout : GradientScout {
