...
/**
 * Job: Grey Path Tracer Team 2.
 * Responsibility: Stitching Grey path fragments into watertight geometric blocks.
 */
object GreyPathTracerTeam2 {
        ...
        while (pool.isNotEmpty()) {
            ...
            if (currentPath.size >= MIN_PATH_SIZE) {
                ...
                if (isBorder) {
                    ...
                    GradientIntelligenceAgency.record(GradientReport(9, currentPath, startColor, endColor, true))
                }
