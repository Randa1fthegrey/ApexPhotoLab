...
/**
 * Job: Green Path Tracer Team 2.
 * Responsibility: Stitching Green path fragments into watertight geometric blocks.
 */
object GreenPathTracerTeam2 {
        ...
        while (pool.isNotEmpty()) {
            ...
            if (currentPath.size >= MIN_PATH_SIZE) {
                ...
                if (isBorder) {
                    ...
                    GradientIntelligenceAgency.record(GradientReport(1, currentPath, startColor, endColor, true))
                }
