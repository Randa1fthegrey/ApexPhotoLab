...
/**
 * Job: Grey Gradient Scout.
 * Responsibility: Pre-scanning the image for gradient transitions within the Grey color group.
 */
object GreyGradientScout : GradientScout {
