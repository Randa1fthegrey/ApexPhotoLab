...
/**
 * Job: Blue Discovery Scout.
 * Responsibility: Discovering raw path fragments for the Blue color group.
 */
object BlueDiscovery {
    ...
    fun trace(
        ...
        return BluePathTracer.trace(candidates, vram, width, sharedRemainingSet)
    }
}
