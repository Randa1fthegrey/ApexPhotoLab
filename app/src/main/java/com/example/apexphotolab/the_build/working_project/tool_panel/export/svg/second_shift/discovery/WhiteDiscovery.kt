...
/**
 * Job: White Discovery Scout.
 * Responsibility: Discovering raw path fragments for the White color group.
 */
object WhiteDiscovery {
    ...
    fun trace(
        ...
        return WhitePathTracer.trace(candidates, vram, width, sharedRemainingSet)
    }
}
