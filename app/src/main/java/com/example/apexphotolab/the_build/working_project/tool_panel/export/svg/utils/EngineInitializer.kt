...
object EngineInitializer {
    ...
    fun warmUp() {
        ...
        runBlocking {
            ...
            val dummyPixels = IntArray(1)
            BlackPathTracer.trace(emptyList<Point>(), dummyVram, 1, dummyPixels)
            RedPathTracer.trace(emptyList<Point>(), dummyVram, 1, dummyPixels)
            GreenPathTracer.trace(emptyList<Point>(), dummyVram, 1, dummyPixels)
            BluePathTracer.trace(emptyList<Point>(), dummyVram, 1, dummyPixels)
            YellowPathTracer.trace(emptyList<Point>(), dummyVram, 1, dummyPixels)
            CyanPathTracer.trace(emptyList<Point>(), dummyVram, 1, dummyPixels)
            MagentaPathTracer.trace(emptyList<Point>(), dummyVram, 1, dummyPixels)
            WhitePathTracer.trace(emptyList<Point>(), dummyVram, 1, dummyPixels)
            AlphaPathTracer.trace(emptyList<Point>(), dummyVram, 1, dummyPixels)
            GreyPathTracer.trace(emptyList<Point>(), dummyVram, 1, dummyPixels)
