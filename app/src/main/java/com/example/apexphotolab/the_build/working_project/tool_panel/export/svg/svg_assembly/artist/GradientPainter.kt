...
/**
 * Job: Gradient Painter.
 * Responsibility: Sampling a shape's start and end colors and producing an SVG linear gradient definition and path element.
 */
object GradientPainter {
    ...
    fun paint(path: List<Point>, source: Bitmap): Pair<String, String> {
        ...
        // 3. Sample inward to avoid transparency leaks
