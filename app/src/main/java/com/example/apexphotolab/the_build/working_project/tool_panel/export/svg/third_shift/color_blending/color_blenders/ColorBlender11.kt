...
/**
 * Job: Color Blender #11 for the color blending pipeline.
 * Responsibility: Performing 13-point ladder sampling across the shape's dominant axis to produce an SVG gradient string.
 */
object ColorBlender11 : ColorBlender {
    ...
    override fun blend(
        ...
        for (i in 0 until sampleCount) {
            ...
            // SLOPE from sourceImage, COLOR from sourceImage
